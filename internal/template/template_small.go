...
type Small struct {
	...
	TemplateName string  `json:"template_name,omitempty" dynamodbav:"template_name" parquet:"name=template_name, type=BYTE_ARRAY, convertedtype=UTF8, encoding=PLAIN_DICTIONARY"`
