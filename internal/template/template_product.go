...
type ProductRating struct {
	RatingValue  float64 `json:"rating_value,omitempty" dynamodbav:"rating_value"`
	Performance  float64 `json:"performance,omitempty" dynamodbav:"performance"`
	Utility      float64 `json:"usability,omitempty" dynamodbav:"usability"`
	Pricing      float64 `json:"pricing,omitempty" dynamodbav:"pricing"`
	BuildQuality float64 `json:"build_quality,omitempty" dynamodbav:"build_quality"`
}

type ProductReview struct {
	Date          string        `json:"date,omitempty" dynamodbav:"date"`
	Author        string        `json:"author,omitempty" dynamodbav:"author"`
	ProductRating ProductRating `json:"rating,omitempty" dynamodbav:"rating"`
}
...
type Product struct {
	...
	ProductSpecs      map[string]string `json:"product_specs,omitempty" dynamodbav:"product_specs"`
	ProductImageLinks []string          `json:"product_image_links,omitempty" dynamodbav:"product_image_links"`
	ProductReviews    []ProductReview   `json:"reviews,omitempty" dynamodbav:"reviews"`
	ProductCategory   []string          `json:"product_category,omitempty" dynamodbav:"product_category"`
	Price             float64           `json:"price,omitempty" dynamodbav:"price"`
	AvgRating         float64           `json:"avg_rating,omitempty" dynamodbav:"avg_rating"`
	NumSold           int64             `json:"num_sold,omitempty" dynamodbav:"num_sold"`
	UploadDate        string            `json:"upload_date,omitempty" dynamodbav:"upload_date"`
	Weight            float64           `json:"weight,omitempty" dynamodbav:"weight"`
	Quantity          int64             `json:"quantity,omitempty" dynamodbav:"quantity"`
	SellerName        string            `json:"seller_name,omitempty" dynamodbav:"seller_name"`
	SellerLocation    string            `json:"seller_location,omitempty" dynamodbav:"seller_location"`
	SellerVerified    bool              `json:"seller_verified,omitempty" dynamodbav:"seller_verified"`
