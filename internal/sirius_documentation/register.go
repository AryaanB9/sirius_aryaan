...
func (r *Register) RegisteredTasks() map[string]TaskRegister {
	return map[string]TaskRegister{
		...
		"/create-s3-bucket":        {"POST", &blob_loading.BlobLoadingTask{}},
		"/delete-s3-bucket":        {"POST", &blob_loading.BlobLoadingTask{}},
		"/create-folder":           {"POST", &blob_loading.BlobLoadingTask{}},
		"/delete-folder":           {"POST", &blob_loading.BlobLoadingTask{}},
		"/create-file":             {"POST", &blob_loading.BlobLoadingTask{}},
		"/update-file":             {"POST", &blob_loading.BlobLoadingTask{}},
		"/delete-file":             {"POST", &blob_loading.BlobLoadingTask{}},
		"/create-files-in-folders": {"POST", &blob_loading.BlobLoadingTask{}},
		"/update-files-in-folder":  {"POST", &blob_loading.BlobLoadingTask{}},
		"/delete-files-in-folder":  {"POST", &blob_loading.BlobLoadingTask{}},
		"/get-info":                {"POST", &blob_loading.BlobLoadingTask{}},
	}
}
